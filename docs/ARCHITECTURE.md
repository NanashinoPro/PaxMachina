...
## 4. シナリオ定義: 北朝鮮周辺諸国 (2025年Q1初期値) — v1.15追記

本シナリオは、**北朝鮮（朝鮮民主主義人民共和国）を中心**とした東北アジア6カ国の地政学的緊張をシミュレーションする。

### 4.1. 参加国と選定理由

| 国名 | 選定理由 |
|:--|:--|
| 北朝鮮 | シナリオの主役。核・ミサイル開発と国際孤立の並立 |
| 韓国 | 一義的な敵国と指定されている直接の対峙国 |
| 中国 | 北朝鮮の唯一の経済的生命線・後ろ盾 |
| ロシア | 2024年の包括的戦略パートナーシップ条約により事実上の軍事同盟国 |
| 日本 | ミサイル脅威の直接的ターゲット。日米安保の一角 |
| アメリカ | 韓国・日本の同盟国。北朝鮮制裁の主導国 |

### 4.2. 初期国家ステータス (2025年Q1基準)

各値の根拠：GDP・軍事費はIMF/SIPRI/韓国銀行推計、人口はUN推計、報道自由度はRSF「2025年世界報道自由度ランキング」、支持率は各種世論調査。

| パラメータ | 北朝鮮 | 韓国 | 中国 | ロシア | 日本 | アメリカ |
|:--|--:|--:|--:|--:|--:|--:|
| government_type | authoritarian | democracy | authoritarian | authoritarian | democracy | democracy |
| economy (GDP, 十億ドル) | 40.0 | 1,800.0 | 19,500.0 | 2,100.0 | 4,200.0 | 29,500.0 |
| military (十億ドル相当) | 28.0 | 47.0 | 250.0 | 170.0 | 55.0 | 930.0 |
| intelligence_level | 35.0 | 60.0 | 110.0 | 90.0 | 55.0 | 120.0 |
| area (km²) | 120,538 | 100,210 | 9,596,960 | 17,098,242 | 377,975 | 9,833,520 |
| approval_rating (%) | 90.0 | 30.0 | 78.0 | 67.0 | 43.0 | 40.0 |
| rebellion_risk | 0.04 | 0.05 | 0.02 | 0.06 | — | — |
| press_freedom | 0.01 | 0.52 | 0.12 | 0.05 | 0.55 | 0.65 |
| human_capital_index (PWT HCI) | 2.100 | 3.630 | 2.630 | 2.780 | 3.500 | 3.774 |
| mean_years_schooling (MYS) | 6.1 | 12.4 | 10.9 | 12.0 | 13.4 | 13.7 |
| population (百万人) | 26.5 | 51.7 | 1,409.0 | 146.0 | 124.0 | 335.0 |
| turns_until_election | — | 8 | — | — | 14 | 12 |
| has_dissolution_power | — | false | — | — | true | false |

**北朝鮮の軍事力（28.0）について**: GFPの通常兵器軍事力指数（世界34位）を参考に、経済規模との乖離（GDP比70%超の軍事費という異常値）を反映した推計値。核戦力は通常兵器評価外であり、`ideology` のペルソナとして表現。

**韓国の支持率（30.0%）について**: 2024年12月の非常戒厳宣布、2025年4月の尹錫悦大統領罷免など、国内政治の極度の混乱を反映。

### 4.3. 初期外交関係マトリクス (2025年Q1基準)

| 関係 | 根拠 |
|:--|:--|
| 北朝鮮↔ロシア: **alliance** | 2024年6月締結「包括的戦略的パートナーシップ条約」による相互防衛条項 |
| 韓国↔アメリカ: **alliance** | 1953年米韓相互防衛条約、USFK在韓米軍駐留継続 |
| 日本↔アメリカ: **alliance** | 1960年日米安全保障条約 |
| 北朝鮮↔韓国: **neutral**（対立） | 双方の制裁あり。北朝鮮は「一切の南北対話を拒否」と明言 |
| 中国↔アメリカ: **neutral**（制裁あり） | 2025年トランプ関税（中国向け45%超）に対する報復関税。貿易戦争状態 |
| ロシア↔日本/韓国: **neutral**（日韓はロシア制裁） | ウクライナ侵攻に伴う経済制裁を継続 |
| 北朝鮮↔中国: **neutral**（貿易あり、中国が経済支援） | 「唇と歯」の関係。中国は北朝鮮の対外貿易の90%以上を占める生命線 |

### 4.4. シナリオの注目ポイント

1. **情報欺瞞（v1.15実装）**: 北朝鮮は`reported_economy`/`reported_military`を使い実態を隠蔽する可能性が高い。`press_freedom = 0.01`のため暴露リスクは極小。
2. **露朝同盟の深化vs日米韓連携**: ロシアからの軍事支援（経済支援5.0B/軍事支援3.0B初期値）と、米韓同盟（経済支援2.0B/軍事支援5.0B）の綱引き。
3. **韓国の政情不安**: 支持率30%・選挙まで8ターン・有志連合参加権なし（has_dissolution_power=false）という三重の制約下での意思決定。
4. **中国の立場**: 北朝鮮の後ろ盾として援助を継続しつつ、対米関係での折り合いをどう取るか。独自の制裁（米中双方向）が経済戦争を深刻化させる。
5. **日本の選択**: 選挙まで14ターン・議会解散権あり。防衛費増額路線（GDP比2%目標）を軍事パラメータ55.0から反映。ロシアへの制裁実施中。
