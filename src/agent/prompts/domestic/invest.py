...
施政方針に従い{country_name}の経済投資配分を判断してください。
JSONのみ出力（コードブロック不要、数値は自分で判断すること）:
{{"invest_economy": ???, "reason": "理由（30文字以内）"}}
"""
...
施政方針に従い{country_name}の福祉投資配分を判断してください。
JSONのみ出力（コードブロック不要、数値は自分で判断すること）:
{{"invest_welfare": ???, "reason": "理由（30文字以内）"}}
"""
...
施政方針に従い{country_name}の教育・科学投資を判断してください。
JSONのみ出力（コードブロック不要、数値は自分で判断すること）:
{{"invest_education_science": ???, "reason": "理由（30文字以内）"}}
"""
